...
util.mktBase64Encode = function (str) {
    ...
    let result = baseStr.substr(0, begin) + trans + baseStr.substr(end, baseStr.length - end) + chars[begin] + chars[end]
    return result;
}
//解密openid
util.mktBase64Decode = function (str) {
    ...
    let baseStr = base.substr(0, begin) + trans + base.substr(end, base.length - end)
